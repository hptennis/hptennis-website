...
// var sheet_url = "https://script.google.com/a/hampdenparktennis.co.uk/macros/s/AKfycbwxj4XcJptMiQbR1yEeNNArrdcQXFhGcQ5zSIkt9bO2/dev"
var sheet_url = "https://script.google.com/macros/s/AKfycby6wkVv9xbATIt8JVeZR71nYxnaKy3n60UJznWo5PYdPaTH2lmT/exec";
  ...
  $("#btnFindMember").click(function (event) {
    ...
    $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
            ...
            $('#id01-firstname').val(response[2]);
            $('#id01-lastname').val(response[3]);
            $('#id01-address1').val(response[4]);
            $('#id01-address2').val(response[5]);
            $('#id01-postcode').val(response[6]);
            $('#id01-phone').val(response[7]);
            $('#id01-email').val(response[8]);
            $("body").toggleClass("wait");
...
$("#btnSubmit").click(function (event) {
    ...
    var surname = $('#id01-lastname').val();
    var name = $('#id01-firstname').val();
    var serial = $('#id01-serial').val();
    var address1 = $('#id01-address1').val();
    var address2 = $('#id01-address2').val();
    var postcode = $('#id01-postcode').val();
    var phone = $('#id01-phone').val();
    var email =$('#id01-email').val();
    var email_option =  $('input[name=email-radio]').val();
    var membership_type =$('#id03-membership').val();
    var payment =  $('input[name=paymethod]').val();
